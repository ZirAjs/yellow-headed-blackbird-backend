...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        birds = [
            ...
            {"name": "헛간올빼미", "time": time(6), "description": "헉산올빼미가 깨어있는 당신을 보고 놀랐습니다"},
            {"name": "수리부엉이", "time": time(6), "description": "수리부엉이가 당신의 열정에 힘입어 큰수리부엉이가 되었습니다"},
            {"name": "올빼미", "time": time(6), "description": "올빼미가 당신과 함께했습니다"},
            {"name": "검은관해오라기", "time": time(6), "description": "검은관해오라기가 당신에게 수고했다고 합니다"},
            {"name": "나이팅게일", "time": time(6), "description": "나이팅게일도 당신을 칭찬합니다"},
            ...
            {"name": "백로", "time": time(7), "description": "백로는 당신이 너무 빛난다 불평합니다"},
            {"name": "흰이마딱새", "time": time(7), "description": "흰이마딱새가 당신을 축하하며 날갯짓을 합니다"},
            
            {"name": "노란머리블랙버드", "time": time(8), "description": "노란머리블랙버드가 당신을 보고 검은머리가 되었습니다"},
            {"name": "기러기", "time": time(8), "description": "기러기가 당신을 보고 뒤집어져 기러기가 되었습니다"},
            {"name": "오리", "time": time(8), "description": "오리가 당신을 푹신히 안아줍니다"},
            {"name": "해오라기", "time": time(8), "description": "해오라기가 당신을 둥지에 초대합니다"},
            {"name": "꿩", "time": time(8), "description": "꿩이 당신에게 오늘은 치킨을 먹으라 합니다"},
        ]
